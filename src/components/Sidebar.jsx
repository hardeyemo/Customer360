...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`hidden sm:flex flex-col justify-between h-screen bg-white border-r p-6 shadow-sm
